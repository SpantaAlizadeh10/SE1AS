"use client";
import FormModal from "@/components2/FormModal";
import Pagination from "@/components2/Pagination";
import Table from "@/components2/Table";
import TableSearch from "@/components2/TableSearch";
import { role, studentsData } from "@/lib2/data";
...
const StudentListPage = () => {
  const renderRow = (item: Student) => (
    <tr
      key={item.id}
      className="border-b border-gray-200 even:bg-slate-50 text-sm hover: bg-se1aPurpleLight"
    >
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className=" flex items-center justify-between">
        <h1 className="text-lg font-demibold hidden md:block">All Students</h1>

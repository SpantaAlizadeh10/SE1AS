...
const SlickCarousel = () => {
  ...
  return (
    <>
      <h2 className="text-center text-2xl font-bold text-gray-700 mb-[-120] mt-[-5] overflow-hidden">
        Events
      </h2>

      <section className="relative w-[90vw] max-w-[800px] h-[450px] mx-auto mt-40 overflow-hidden">
          ...
          return (
            ...
            >
              <img
                src={image}
                alt={name}
                className="w-[450px] h-[350px] rounded-sm mb-4 object-cover border-4 border-primary-300 shadow-lg mx-auto overflow-hidden"
              />
